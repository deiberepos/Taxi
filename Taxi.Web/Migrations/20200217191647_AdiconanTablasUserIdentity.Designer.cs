...
namespace Taxi.Web.Migrations
{
    ...
    [Migration("20200217191647_AdiconanTablasUserIdentity")]
    partial class AdiconanTablasUserIdentity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taxi.Web.Entities.UserEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Taxi.Web.Entities.UserGroupEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Taxi.Web.Entities.UserEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("Taxi.Web.Entities.TaxiEntity", b =>
                {
                    b.HasOne("Taxi.Web.Entities.UserEntity", "User")
                        .WithMany("Taxis")
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("Taxi.Web.Entities.UserEntity", b =>
                {
                    b.HasOne("Taxi.Web.Entities.UserGroupEntity")
                        .WithMany("Users")
